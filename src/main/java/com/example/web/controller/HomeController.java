...
public class HomeController {
	...
	public String getHome(@AuthenticationPrincipal User user, @NonNull Model model) {
		...
		model.addAttribute("helper", new ViewHelper("hello spring!!", account.getAccounts(), user));
		return "home";
	}
	...
	public static class ViewHelper {
		...
		public List<AccountRow> getAccountRows() {
			return accounts.stream()
					.map(a -> AccountRow.builder().name(a.getName()).editUrl("/admin/accounts/" + a.getId() + "/edit").build())
